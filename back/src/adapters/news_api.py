...
from src.adapters.schemas.filter import BaseFilter
from src.adapters.schemas.news import NewsResponse
...
class NewsAdapter(NewsClient):
    ...
    async def get_url(self, filter: BaseFilter) -> str:
    ...
    async def get_news(self, filter: BaseFilter) -> NewsResponse:
        response_news = None
